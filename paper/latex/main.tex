...
\toprule
\textbf{Task} & \textbf{GT} & \textbf{Single (en)} & \textbf{Single (ko)} & \textbf{SF-Active (en)} & \textbf{SF-Active (ko)} \\
\midrule
DB migration   & 5 & 3F+2P & \textbf{5F}  & \textbf{5F} & 2F+3P \\
Auth overhaul  & 5 & 5F    & 4F+1P        & \textbf{5F} & \textbf{5F} \\
Microservice   & 6 & 5F+1P & ---          & \textbf{6F} & \textbf{6F} \\
\bottomrule
\end{tabular}
\end{table}
