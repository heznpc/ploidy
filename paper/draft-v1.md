...
**Ploidy achieved 5/5 detection in both runs.** Single Session varied from 3 to 4 found. On the most bias-laden task, Ploidy's recall was deterministic while Single's was stochastic.
