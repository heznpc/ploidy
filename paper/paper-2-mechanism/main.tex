...
Ploidy's recall on this task was consistent across limited runs (5/5 in both runs, $n{=}2$) while Single's varied (3--4/5). This stability, rather than the absolute F1 value, is the most noteworthy observation from these pilot experiments. However, two runs are insufficient to establish deterministic behavior; confirming this would require $\geq$5 repetitions with statistical testing.
